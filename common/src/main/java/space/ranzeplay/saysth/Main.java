...
public final class Main {
    ...
    public static void init(Path configDir, ProfessionExtractor professionExtractor, Logger logger){
        if (logger == null) {
        ...
        try {
            CONFIG_MANAGER.createConfigIfNotExists(professionExtractor);
