    ...
    public @NotNull List<ToolSpecification> getTools() {
        ...
        return List.of(
            ToolSpecification.builder()
                ...
                .addParameter("timezone", String.class, 
                    "Timezone identifier (e.g., 'UTC', 'America/New_York', 'Europe/London'). Defaults to 'UTC'.")
                .addParameter("format", String.class,
                    "Optional date/time format pattern. Defaults to ISO format.")
                .build(),
